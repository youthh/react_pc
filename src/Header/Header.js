            ...
            <div className="container">
                <div className="inner_header">
                                        ...
                                        return <li className="search_item">
                                            <NavLink onClick={() => {
                                                ...
                                                setFilter([]);
                                                     ...
                                                     key={key}
                                                     to={"Movies/" + m.genre + '/'+ m.name + '/' + (m.id - 1).toString()}>{m.name}</NavLink>
                                        </li>
                                    })
                                }
                            </div>
                    ...
                    <div className="block_logIn" ref={reference}>
                        {props.authS ?
                            <div onClick={() => props.setIsMenuOpen(o => !o)} className="user_room">
                                <div className="ava">
                                    <img
                                        src={props.img ? props.img : "https://img.icons8.com/dusk/64/000000/small-smile.png"}/>
                                </div>
                                <p className="login_col">{props.login}</p></div>
